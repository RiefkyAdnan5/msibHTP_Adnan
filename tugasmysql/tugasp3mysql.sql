...
SELECT * FROM produk WHERE kode LIKE 'T%' OR kode LIKE 'K%';
...
SELECT * FROM pelanggan WHERE tmp_lahir LIKE 'Kediri%' OR tmp_lahir LIKE 'Yogyakarta%' OR tmp_lahir LIKE 'Bandung%' OR nama_pelanggan LIKE '&yo&';
...
SELECT * FROM produk ORDER BY harga_beli;
