...
<?php
    function skor_skill($ar_skill,$predikat){
        if (($ar_skill) >= 100 && ($ar_skill) <= 160 ) $predikat = 'Sangat Baik';
        else if (($ar_skill) >= 60 && ($ar_skill) < 100 ) $predikat = 'Baik';
        else if (($ar_skill) >= 40 && ($ar_skill) < 60 ) $predikat = 'Cukup';
        else if (($ar_skill) >= 10 && ($jml_skill) < 40 ) $predikat = 'Kurang';
        else if (($ar_skill) == 0) $predikat = 'Tidak Memadai';
        return $predikat;
    } 
?>
